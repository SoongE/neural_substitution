...
from timm.models import checkpoint_seq, build_model_with_cfg, register_model


class Downsample(nn.Module):

    def __init__(self, in_chs, out_chs, stride=1, dilation=1, n_block=1, stochastic=1.0):
        super().__init__()
...
class ConvNeXt(nn.Module):
    ...
    def init_weights(self, bn_init=False, head_init_scale=1.0):
        for n, m in self.named_modules():
            ...
            elif bn_init and isinstance(m, nn.BatchNorm2d):
