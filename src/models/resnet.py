...
backbones = {
    ...
    'resnext50': dict(block=Bottleneck, layers=[3, 4, 6, 3], cardinality=32, base_width=4),
}

methods = {
    'origin': dict(add_block=ConvBNBlock, n_block=1),
...
def AddResNet(name, pretrained=False, **kwargs):
    ...
    return _create_resnet('ResNetAdd', pretrained, **model_args)


if __name__ == '__main__':
    AddResNet('resnet18_Add33', stem_type='cifar')(torch.rand(2, 3, 32, 32))
